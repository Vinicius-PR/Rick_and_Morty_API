...
export default function Characters() {
  ...
  const { data, isLoading, isError, error } = useQuery(["characters", page], fetchCharacters,
  ...
  return (
    <Main>
      <Pagination page={page} numberOfPages={data?.info.pages} haddleChangePage={setPage}/>
